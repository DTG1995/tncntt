...
class AppController extends Controller
{
    ...
    {
        $this->Auth->allow(['display','gethint','getresult','getcommentdefine','getcommentmean','comment','adduser','addwordmean','contribute','changecontribute','warning','addNotification','login','signup','like']);
    }
}
