        ...
        <table cellpadding="0" cellspacing="0" class="table table-striped">
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Html->link(__("<i class='fa fa-pencil'></i>"), ['controller' => 'Definitions', 'action' => 'edit', $definitions->id],[ 'escape' => false,'title'=>'Sửa']) ?>
        ...
        <table cellpadding="0" cellspacing="0" class="table table-striped">
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Html->link(__("<i class='fa fa-pencil'></i>"), ['controller' => 'Means', 'action' => 'edit', $means->id],[ 'escape' => false,'title'=>'Sửa']) ?>
