        ...
        <div class="content-contributes">
            <?php
                ...
                <div class="contribute-content <?=$i%2==0?'chang':'le'?>" >
                    <div class="content-contribute col-md-11">
                        <div class='col-define'>
                            <p class="word"><?=$mean->word?><span class="cate-contribute"><?=$define->cate_name?></span></p>   
                            <p class="define"><?=$mean->mean?></p>
                        </div>
                        <div>
                            <p class="username-contribute"><?=$mean->username?><a class="readmore-contribute" data-toggle="collapse" data-target="#readmore-contribute-define-<?=$define->id?>">Xem nghĩa đầy đủ...</a></p>
                        </div>
                    </div>
                    <div class="contributes col-md-1" id="contribute">
