...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2017 at 03:28 AM
...
INSERT INTO `accounts` (`ID`, `EMAIL`, `NAMEDISPLAY`, `PASSWORD`, `ISADMIN`, `CREATED`, `LAST_LOGIN`, `STATUS`, `ACTIVE`) VALUES
(1, 'abc@123.a', 'DTG', '$2y$10$T6nyqzZVpdun8EkqQtb2leTTjFXVL6LE3ZwqV6auXjH.O.vSOsEsu', 1, '2017-02-21 00:00:00', '2017-02-24 23:51:00', 1, 0);
...
ALTER TABLE `likedefinitions`
  ADD PRIMARY KEY (`IDDEFINITION`,`ACCOUNT`),
  ADD KEY `ACCOUNT` (`ACCOUNT`);
...
ALTER TABLE `likemeans`
  ADD PRIMARY KEY (`IDMEAN`,`ACCOUNT`),
  ADD KEY `ACCOUNT` (`ACCOUNT`);
...
ALTER TABLE `commentdefinitions`
  ...
  ADD CONSTRAINT `commentdefinitions_ibfk_2` FOREIGN KEY (`ACCOUNT`) REFERENCES `accounts` (`ID`);
...
ALTER TABLE `commentmeans`
  ...
  ADD CONSTRAINT `commentmeans_ibfk_2` FOREIGN KEY (`ACCOUNT`) REFERENCES `accounts` (`ID`);
...
ALTER TABLE `definitions`
  ...
  ADD CONSTRAINT `definitions_ibfk_2` FOREIGN KEY (`ACCOUNT`) REFERENCES `accounts` (`ID`);
...
ALTER TABLE `likedefinitions`
  ...
  ADD CONSTRAINT `likedefinitions_ibfk_2` FOREIGN KEY (`ACCOUNT`) REFERENCES `accounts` (`ID`);
...
ALTER TABLE `likemeans`
  ...
  ADD CONSTRAINT `likemeans_ibfk_2` FOREIGN KEY (`ACCOUNT`) REFERENCES `accounts` (`ID`);
...
ALTER TABLE `means`
  ...
  ADD CONSTRAINT `means_ibfk_2` FOREIGN KEY (`ACCOUNT`) REFERENCES `accounts` (`ID`);
